...
(function () {
  ...
  Raphael.fn.presus.start_block = function (sx,sy,ex,ey,percent,txt1,despl,color){
    ...
    this.path(["M",sx,sy,"L",sx+ex,sy,"C",(ex+l),sy,(305-l),y,305,y,"L",305+20,y,"L",305+20,y+260*percent/100,"L",305,y+260*percent/100,"C",(305-l),y+260*percent/100,(ex+l),sy+ey,ex,sy+ey,"L",sx,sy+ey,"L",sx+10,sy+ey/2,"z"]).attr({fill: color, "stroke-width": 0, opacity: percent/100.0+0.35});//.attr({fill: "url(http://www.irunmywebsite.com/images/irunmywebsitesmall.png)", stroke: color});
  ...
  Raphael.fn.presus.end_block = function (sx,sy,ex,ey,percent,txt1,despl,color){
    ...
    this.path(["M",459+sx,sy,"L",459+sx+ex,sy,"L",459+sx+ex-10,sy+ey/2,"L",459+sx+ex,sy+ey,"L",459+sx,sy+ey,"C",459+sx-l,sy+ey,355+l,despl+130,355,despl+130,"L",335,despl+130,"L",335,despl+130-260*percent/100,"L",355,despl+130-260*percent/100,"C",355+l,despl+130-260*percent/100,459+sx-l,sy,459+sx,sy,"z"]).attr({fill: color, "stroke-width": 0, opacity: percent/100.0+0.35});
